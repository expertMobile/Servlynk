...
class DropdownMenu extends Component {
  ...
  renderActivityPanel() {
    if (this.state.activityIndex >= 0) {
      ...
      return (
        <View style={{zIndex: 11100000, backgroundColor: 'black', height: 300}}>
  ...
  render() {
    ...
    return (
      <View style={{zIndex: 10000, flexDirection: 'column', flex: 1}} >
        <View style={{
            zIndex: 1000000,
            flexDirection: 'row',
            backgroundColor: this.props.bgColor ? this.props.bgColor : this.defaultConfig.bgColor}} >
          {
            ...
            key={index}
            style={{flex: 1, height: 48, alignItems: "center", justifyContent: "center", borderColor: '#777', borderWidth: 1}} >
